...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a class="<?= $page_title=='RMSに出品されている商品の一括削除'?'active':'' ?>" href="/rms-item-delete">RMS商品削除</a></li>
            ...
            <li class="menu-item hidden"><a class="<?= $page_title=='デフォルト追跡価格設定'?'active':'' ?>" href="/tracking-price-setting">デフォルト追跡価格設定</a></li>
            <li class="menu-item hidden"><a class="<?= $page_title=='メールテンプレート編集'?'active':'' ?>" href="/mail-template">メールテンプレート</a></li>
            <li class="menu-item hidden"><a class="<?= $page_title=='ユーザー情報編集'?'active':'' ?>" href="/my-account">ユーザー情報編集</a></li>
