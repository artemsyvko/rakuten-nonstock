...
<section>
    ...
    <div class="register-form">
        ...
        <div class="mb-3 row">
            <?= form_label('Username: ', 'username', ['class'=>'col-sm-4 col-form-label']) ?>
            <div class="col-sm-8">
                <?= form_input('username', '', ['class'=>'form-control'], 'text') ?>
            </div>
        </div>

        <div class="mb-3 row">
            <?= form_label('Password: ', 'password', ['class'=>'col-sm-4 col-form-label']) ?>
            <div class="col-sm-8">
        ...
        <div class="mb-3 row">
            <?= form_label('Password re-enter: ', 'passcheck', ['class'=>'col-sm-4 col-form-label']) ?>
            <div class="col-sm-8">
                <?= form_password('passcheck', '', ['class'=>'form-control']) ?>
            </div>
        </div>

        <?= form_submit('', 'Sign up', ['class'=>'btn btn-primary']) ?>
    </div>
